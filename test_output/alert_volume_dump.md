...
Generated: 2026-04-29 17:13:26 UTC
...
- Output:
  ...
  - Running call 1 for alert #15 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #15 (Dump Volume Test)
  - Call 2 result: False
- Expected: []
- Actual: []
- Result: PASS
...
- Output:
  ...
  - Assumptions: Only Item A should survive the hourly-volume gate.
  - Alert kwargs: {'is_all_items': True, 'dump_liquidity_floor': 10000000, 'dump_rel_vol_min': 0.1}
  - Running call 1 for alert #16 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #16 (Dump Volume Test)
...
- Output:
  ...
  - Running call 1 for alert #17 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #17 (Dump Volume Test)
  - Call 2 result: False
- Expected: []
- Actual: []
- Result: PASS
...
- Output:
  ...
  - Running call 1 for alert #18 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #18 (Dump Volume Test)
  - Call 2 result: [{'item_id': '4151', 'item_name': 'Abyssal whip', 'fair_value': 997.0, 'current_low': 880, 'discount_pct': 11.75, 'sell_ratio': 0.85, 'rel_vol': 1.0, 'shock_sigma': -1.0, 'volume': 20000000, 'spike_volume': 20000000}]
- Expected: ['4151']
- Actual: ['4151']
- Result: PASS
...
- Output:
  ...
  - Running call 1 for alert #19 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #19 (Dump Volume Test)
  - Call 2 result: False
- Expected: False
- Actual: False
- Result: PASS
...
- Output:
  ...
  - Running call 1 for alert #20 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #20 (Dump Volume Test)
  - Call 2 result: False
- Expected: False
- Actual: False
- Result: PASS
...
- Output:
  ...
  - Running call 1 for alert #21 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #21 (Dump Volume Test)
  - Call 2 result: False
- Expected: False
- Actual: False
- Result: PASS
...
- Output:
  ...
  - Running call 1 for alert #22 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #22 (Dump Volume Test)
  - Call 2 result: False
- Expected: False
- Actual: False
- Result: PASS
...
- Output:
  ...
  - Running call 1 for alert #23 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #23 (Dump Volume Test)
  - Call 2 result: True
- Expected: True
- Actual: True
- Result: PASS
...
- Output:
  ...
  - Assumptions: All other dump thresholds are loose enough to let volume be the deciding factor.
  - Alert kwargs: {'item_id': 4151, 'dump_liquidity_floor': 10000000, 'dump_rel_vol_min': 0.1}
  - Running call 1 for alert #24 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #24 (Dump Volume Test)
  - Call 2 result: True
- Expected: True
- Actual: True
- Result: PASS
...
- Output:
  ...
  - Running call 1 for alert #25 (Dump Volume Test)
  - Call 1 result: False
  - Running call 2 for alert #25 (Dump Volume Test)
  - Call 2 result: True
- Expected: True
- Actual: True
- Result: PASS
